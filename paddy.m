...
g_plan = [0; -3.711];	% Other planet gravity, m/s^2
...
% initial and final conditions -- dynamics  [x z]
r_0 = [1500; 2000];		% position vector, m
v_0 = [70; -75];		% velocity vector, m/s
r_N =[0; 0];			% terminal position, m
v_N =[0; 0];			% terminal velocity, m
...
cvx_begin
	...
	subject to 				% constraints and dynamics
		...
		r(2,:) >= 0;							% plz don't crash into the ground
